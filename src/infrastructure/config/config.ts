...
export const config = {
  ...
  loki: {
    ...
    labels: { job: parsedConfig?.LOKI_LABEL_JOB != null ? parsedConfig.LOKI_LABEL_JOB : 'fs-status-api' },
  ...
  redis: {
    ...
    instanceSet: parsedConfig?.REDIS_INSTANCE_SET != null ? parsedConfig.REDIS_INSTANCE_SET : 'instances',
  },
  featureServer: {
